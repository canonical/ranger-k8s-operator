...
The charm generates its own Ranger passwords; no secret configuration is needed.
See [Managing credentials in the README](./README.md#managing-credentials) for
reading and rotating them.
